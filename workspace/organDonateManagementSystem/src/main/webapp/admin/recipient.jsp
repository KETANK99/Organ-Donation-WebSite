                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Recipient's List</h4>
                                </div><!--end card-header-->
                                <div class="card-body">
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                            <table id="tech-companies-1" class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                <%
                                                PreparedStatement ps=Dbconnection.con.prepareStatement("select b.BloodGroupName,r.*,FLOOR((TIMESTAMPDIFF(MONTH, r.Recipient_dob, CURDATE()) / 12)) as Age from Recipient as r inner join bloodgroups as b on r.blood_category=b.id");
	    ...
	    <script>
	   	function updatStatus(id,a)
	   	{
			 ...
			 $.ajax({
			        ...
			        data:"id="+id+"&status="+a+"&userType=r", // serializes the form's elements.
